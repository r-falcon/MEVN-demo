  ...
  <div class="app-container">
    <el-card>
      ...
      <el-table v-loading="loading" :data="tableData" style="width: 100%">
        ...
        <el-table-column label="收获地址" align="center" prop="buyerAddress" />
        <el-table-column label="联系方式" align="center" prop="buyerPhone" />
...
<script>
import { getOrderList, orderDelete } from "@/api/fresh/order";
...
export default {
  ...
  methods: {
    ...
    handleEdit(record) {
      ...
      if (record.buyerAddress && validatenull(record.buyerAddress)) {
        record.buyerAddress = record.buyerAddress.split(",");
      }
